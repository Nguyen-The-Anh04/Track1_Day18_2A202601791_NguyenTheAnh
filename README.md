...
## 2. HYPOTHESIS PROBLEM (BẢN CHỐT DAY 18)
...
## 3. THREE SOLUTION OPTIONS (MÔ TẢ CÁC OPTION)
- **Option A: User-Led (On-Demand AI Tutor)**
  ...
  - **Link Prototype:** [Xem tại prototype-link.md](prototype-link.md)
...
- **Trách nhiệm Option:** Phụ trách chính thiết kế và kiểm thử Option A (User-Led).
- **Đóng góp Shared Context/Content:** Tổng hợp bài học mẫu (Design the Experiment - Slide 7) làm dữ liệu thử nghiệm chuẩn cho cả 3 Options.
- **Human-AI Decisions:** Đóng góp xây dựng bảng phân định Agency & Control, quy định cơ chế Recovery khi AI đưa ra phản hồi quá chung chung hoặc mờ nghĩa.
- **Facilitation & Observation:** Trực tiếp facilitate phiên User Testing với 1 tester ngoài nhóm, ghi nhận Feedback Note và tổng hợp vào Group Synthesis.

---

## 5. PROTOTYPE FEEDBACK & NEXT CHANGE
- **Tóm tắt Observation cá nhân:** (Sẽ cập nhật sau Chặng 6)
- **Next Change của Nhóm:** (Sẽ cập nhật sau Chặng 6)
- **Điều vẫn chưa chứng minh được (Still Unproven):** (Sẽ cập nhật sau Chặng 6)
